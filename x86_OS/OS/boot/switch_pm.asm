...
or eax , 0x1 
mov cr0 , eax
jmp CODE_SEG : init_pm ; Make a far jump ( i.e. to a new segment ) to our 32- bit code. This also forces the CPU to flush its cache of pre-fetched and real-mode decoded instructions , which can cause problems. far jumps places the CODE_SEG value (index of code segment in GDT) in cs register. init_pm is offset in code segment.
