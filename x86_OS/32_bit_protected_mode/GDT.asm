...
; type flags : ( code )1 ( conforming )0 ( readable )1 ( accessed )0 -> 1010 b           conforming :If this bit is set, then less privileged code segments is allowed to jump to or call this segment.
