...
%include "/media/sf_Shared_Folder/WYOOS_NICK_BLUNDELL/Kernel/my_print.asm"
%include "/media/sf_Shared_Folder/WYOOS_NICK_BLUNDELL/Kernel/disk_load.asm"
%include "/media/sf_Shared_Folder/WYOOS_NICK_BLUNDELL/Kernel/GDT.asm"
%include "/media/sf_Shared_Folder/WYOOS_NICK_BLUNDELL/Kernel/print_pm.asm"
%include "/media/sf_Shared_Folder/WYOOS_NICK_BLUNDELL/Kernel/switch_pm.asm"
